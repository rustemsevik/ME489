...
// !nvcc -arch=sm_60 kmeans.cu -o gpu_kmeans -diag-suppress 2464 -diag-suppress 177
// !./kmns ./input.dat ./circle_N4000.dat
...
int main (int argc, char *argv[]) {
    ...
    // Calculate number of thread-blocks and threads per thread-block to use
    int T = 512;
